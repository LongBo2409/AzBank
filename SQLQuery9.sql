...
-- CHECK constraint on the Amount column of the CustomerTransaction table to ensure that each transaction amount is within the specified range (greater than 0 and less than or equal to $1,000,000)CHECK constraint on the Amount column of the CustomerTransaction table to ensure that each transaction amount is within the specified range (greater than 0 and less than or equal to $1,000,000)
